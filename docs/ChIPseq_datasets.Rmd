...
```{r, eval = FALSE}
# Import data files
H3K4me3 <- import.bw(file.path(here::here("data",
                                          "ChIPseq",
                                          "GSM4809272_ChIP_THP1_WT_aH3K4me3.bw")))
NegCtrl <- import.bw(file.path(here::here("data",
                                          "ChIPseq",
                                          "GSM4809295_ChIP_THP1_sgNegCtrl_aH4K8ac.bw")))
K2 <- import.bw(file.path(here::here("data",
                                     "ChIPseq",
                                     "GSM4809296_ChIP_THP1_sgKANSL2_aH4K8ac.bw")))
K3<- import.bw(file.path(here::here("data",
                                    "ChIPseq",
                                    "GSM4809297_ChIP_THP1_sgKANSL3_aH4K8ac.bw")))
K8<- import.bw(file.path(here::here("data",
                                    "ChIPseq",
                                    "GSM4809298_ChIP_THP1_sgKAT8_aH4K8ac.bw")))
```
